//source: https://github.com/yunusfebriansyah/struktur-data/blob/main/Double%20Linked%20List/src/Main.cpp
...
DataUser *head, *tail, *cur, *newNode, *removedNode, *afterNode;
...
// Add after
void addAfter( string data[4], int posisi ){
  if( head == NULL ){
    cout << "Double Linked List belum dibuat!!!";
  }else{
